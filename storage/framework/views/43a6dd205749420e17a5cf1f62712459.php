...
<h1>Edit Products</h1>
    ...
    <form action="<?php echo e(route('shop.update', $product->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /home/i/Documents/Laravel/mostDonePos/resources/views/shop/edit.blade.php ENDPATH**/ ?>