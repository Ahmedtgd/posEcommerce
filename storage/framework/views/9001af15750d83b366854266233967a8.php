...
<section>
  <div :class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'" class="fixed right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300">
        ...
        <div class="flex justify-between mt-6" id="productFields" data-category="<?php echo e($product->category_id); ?>">
                ...
                <div class="mt-6 lg:mt-0 lg:px-2 lg:w-4/5 ">
                    ...
                    <img class=" hover:shadow-lg" src=  "<?php echo e(asset('storage/img/' . $product->file)); ?>" width="240" height="120" style="border-radius: 10px;" class="card-img-top"   >
                            ...
                            <p class="text-blue-500">$<?php echo e($product->price); ?> </p>
                             ...
                             <button type="button" id="addProductButton" class="flex btn btn-secondary">
...
function addProductToCart(productId, productName, price, quantity) {
  // Check if cart object exists in your code
  if (!window.cart) {
    window.cart = {};
  }

  // Update cart object with product information
  ...
  // Update cart section dynamically (using your preferred method)
  updateCartSection();
}
...
const price = 10.99; // Assuming you have price information accessible
const quantity = document.getElementById('quantity').value;

addProductToCart(productId, productName, price, quantity);
function updateCartSection() {
  // Clear existing cart items (if applicable)
  const cartList = document.getElementById('cart-list');
  cartList.innerHTML = '';

  // Iterate through cart object and create HTML elements
  for (const productId in window.cart) {
    const product = window.cart[productId];
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        <div class="flex justify-between mt-6" id="newProduct" data-category="<?php echo e($product->category_id); ?>">
            <div class="flex">
                <img class="h-20 w-20 object-cover rounded" src="<?php echo e(asset('storage/img/' . $product->file)); ?>" alt="">
                <div class="mx-3">
                    <h3 class="text-sm text-gray-600"><?php echo e($product->name); ?></h3>
            ...
            <span class="text-gray-600"><?php echo e($product->price); ?>$</span>
        </div>
            </div>
        `;
...
<?php endif; ?>
<?php /**PATH /home/i/Documents/Laravel/mostDonePos/resources/views/shop/create.blade.php ENDPATH**/ ?>