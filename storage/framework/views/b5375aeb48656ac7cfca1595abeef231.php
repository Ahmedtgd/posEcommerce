            ...
            <div class="lg:flex lg:-mx-2">
             ...
             <a  href="/shop" class="block font-medium text-gray-500 dark:text-gray-300 hover:underline">All</a>
                ...
                <div class="mt-6 lg:mt-0 lg:px-2 lg:w-4/5 ">
                    ...
                    <img class="hover:grow hover:shadow-lg" src=  "<?php echo e(asset('storage/img/' . $product->file)); ?>" width="240" height="120" style="border-radius: 10px;" class="card-img-top"   >
...
<?php endif; ?>
<?php /**PATH /home/i/Documents/Laravel/mostDonePosE/resources/views/shop/index.blade.php ENDPATH**/ ?>