        ...
        <div class="container mx-auto px-6 py-3">
            ...
            <nav :class="isOpen ? '' : 'hidden'" class="sm:flex sm:justify-center sm:items-center mt-4">
                <div class="flex flex-col sm:flex-row">
                    ...
                    <a class="mt-3 text-gray-600 hover:underline sm:mx-3 sm:mt-0" href="{{ route('shop.create') }}" >Shop</a>
...
-->
            ...
            <div class="lg:flex lg:-mx-2">
             ...
             <a  href="{{ route('shop.create') }}" class="block font-medium text-gray-500 dark:text-gray-300 hover:underline">All</a>
                 @foreach($categories as $category)


                    <a id="category" data-category="{{ $category->id }}" href="#" class="block font-medium text-gray-500 dark:text-gray-300 hover:underline">{{ $category->category_name }}</a>
                  @endforeach
                     </div>
                ...
                <div class="mt-6 lg:mt-0 lg:px-2 lg:w-4/5 ">
                    ...
                    @foreach ($products as $product)
                        ...
                        <div id="product" data-category="{{ $product->category_id }}" class="flex flex-col items-center justify-center w-full max-w-lg mx-auto">
                    <img class="mx-auto d-block" src=  "{{ asset('storage/img/' . $product->file) }}" width="240" height="120" style="border-radius: 10px;" class="card-img-top"   >
...
<div class="flex justify-between mt-4">
    <a href="{{ $products->previousPageUrl() }}" class="inline-block px-2 py-1 text-gray-700 hover:text-blue-500">Previous</a>
    @if ($products->hasPages())
        {{ $products->links() }}
    @endif
    <a href="{{ $products->nextPageUrl() }}" class="inline-block px-2 py-1 text-gray-700 hover:text-blue-500">Next</a>
</div>
